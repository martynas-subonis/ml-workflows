...
def train_model(
    ...
    torch_with_transform_model: Output[Model],
    ...
    torch.save(model_with_transform.state_dict(), torch_with_transform_model.path)
    torch_with_transform_model.framework = setup_info
